...
int main() {
    ...
    MemoryAllocator mem_allocator(mem_allocator_bytes);
    OrderBook order_book(mem_allocator, bench_min_price, bench_max_price, num_order_events, order_table_size);
    ...
    std::cout << "OrderBook Stats for " << num_order_events << " Orders\n";
